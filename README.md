...
5. ### State with the highest or lowest beneficiary registration numbers
   Abuja-FCT recorded the highest total registrations across all years, with 2,966, while Jigawa had the lowest with 2,638.[See Details Here](https://github.com/Giles720/Registration-Analysis/blob/main/Registration%20by%20states.xlsx)
